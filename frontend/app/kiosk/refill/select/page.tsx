...
export default function KioskRefillSelectPage() {
  ...
  const Row = ({
    ...
    <div
      className="rounded-xl px-4 py-4 sm:px-5 sm:py-4 md:px-6 md:py-5 grid grid-cols-1 sm:grid-cols-[minmax(0,1fr)_auto_auto] items-center gap-3 sm:gap-4"
    ...
    >
      ...
      <div className="flex items-center justify-center md:justify-start">
        <div className="grid grid-cols-3 overflow-hidden rounded-lg border border-[#D0DFE8] bg-white min-w-[170px] md:min-w-[210px] h-[44px] md:h-[52px]">
          <button
            onClick={() => dec(id)}
            className="flex items-center justify-center text-[28px] md:text-[34px] font-light border-r border-[#DCE6ED] leading-none"
            style={{ color: "#189CD2" }}
          >
            −
          </button>
          <div
            className="flex items-center justify-center text-[24px] md:text-[28px] font-medium border-r border-[#DCE6ED] leading-none"
            style={{ color: "#1D6788" }}
          >
          ...
          <button
            onClick={() => inc(id)}
            className="flex items-center justify-center text-[28px] md:text-[34px] font-light leading-none"
            style={{ color: "#189CD2" }}
          >
            +
          </button>
      ...
      <div className="w-full max-w-xl md:max-w-2xl bg-white rounded-2xl md:rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <div className="px-4 py-5 sm:px-5 sm:py-6 md:px-8 md:py-8">
          ...
          <div className="text-center">
            ...
            <p className="text-xs md:text-sm mt-1" style={{ color: "#8E8E8E" }}>
